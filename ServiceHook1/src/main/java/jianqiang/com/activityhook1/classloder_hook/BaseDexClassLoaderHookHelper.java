...
public final class BaseDexClassLoaderHookHelper {
    ...
    public static void patchClassLoader(ClassLoader cl, File apkFile, File optDexFile)
        ...
        L.i("BaseDexClassLoaderHookHelper.patchClassLoader() pathListObj:" + pathListObj);
        // 获取 PathList: Element[] dexElements
        Object[] dexElements = (Object[]) RefInvoke.getFieldObject(pathListObj, "dexElements");
        L.i("BaseDexClassLoaderHookHelper.patchClassLoader() dexElements:" + dexElements);

        // Element 类型
        Class<?> elementClass = dexElements.getClass().getComponentType();
        L.i("BaseDexClassLoaderHookHelper.patchClassLoader() elementClass:" + elementClass);

        // 创建一个数组, 用来替换原始的数组
        Object[] newElements = (Object[]) Array.newInstance(elementClass, dexElements.length + 1);
        L.i("BaseDexClassLoaderHookHelper.patchClassLoader() newElements:" + newElements);
        ...
        L.i("BaseDexClassLoaderHookHelper.patchClassLoader() o:" + o);
